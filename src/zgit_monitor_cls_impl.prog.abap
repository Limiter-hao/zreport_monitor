  ...
  METHOD handle_user_command.
    ...
    CASE e_ucomm.
      ...
      WHEN 'SEL_TAB' OR 'MASK' OR 'EXECUTE' OR 'DEBUG'.
        ...
        "从datebase中获取数据
        DATA lv_id(62) TYPE c.
        DATA lt_sel_table TYPE TABLE OF rsparams.
        CLEAR:lv_id,lt_sel_table.
        ASSIGN COMPONENT 'STARTTIME' OF STRUCTURE gs_detail TO FIELD-SYMBOL(<fs_starttime>).
        CONCATENATE <fs_repid> <fs_starttime> INTO lv_id RESPECTING BLANKS.
        IMPORT sel_table = lt_sel_table FROM DATABASE ztabap_rep_mon(mo) ID lv_id.
